...
if __name__ == "__main__":
    ...
    url = urllib.parse.urlparse('https://www.coleka.com/fr/figurines-de-collection/funko/funko-pop-vinyl_r2191')

    print(block_content)


    for content in block_content.findAll('li', attrs={'class' : 'col-sm-3 col-xs-6'}):
        print(content.find('a', attrs={'class' : ['lib_has_3_lines','defer lib_has_3_lines','  defer lib_has_3_lines', 'defer lib_has_2_lines']})['href'])
        updated_url = urllib.parse.urlparse('https://www.coleka.com/fr/figurines-de-collection/funko/funko-pop-vinyl_r2191')._replace(path=content.find('a', attrs={'class' : ['lib_has_3_lines','defer lib_has_3_lines','  defer lib_has_3_lines', 'defer lib_has_2_lines']})['href'])

        print(urllib.parse.urlunparse(updated_url))
        pop2 = PopScrapper(urllib.parse.urlunparse(updated_url))
        html2 = pop2.request_url()
        block_content2 = html.find('ul', attrs={'class' : 'row img-list list-item'})

        print(block_content2)
        print()
        print()
        print()
